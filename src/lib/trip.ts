...
export const TRIP: Trip = {
  ...
  flights: [
    ...
    { id: "f2", date: "11 мая", code: "AF 1295", airline: "Air France", from: "BUD", to: "CDG", time: "12:40 → 14:55", dur: "2ч 35м", tip: "Конфликт со сном Стеллы 13:00–15:00. Возьмите тёплый плед и наушники." },
  ...
  baggage: [
    ...
    { id: "kids", label: "Дети", items: [
      { t: "Любимая игрушка Стеллы (без неё нет сна)", done: true },
    ...
    { id: "gear", label: "Снаряжение", items: [
      { t: "Эрго-рюкзак для Стеллы (вместо коляски)", done: true },
  ...
  budapest: {
    ...
    places: [
      { id: "b1", name: "Будапештский зоопарк", emoji: "🦁", tag: "wow", dist: "450 м · 6 мин пешком", dur: "3 часа", age: "0+", price: "€26 семья", subtitle: "Купольная пальмерия, тигры, жирафы. Идеален с 2-летним.", addr: "Állatkerti krt. 6–12, в Городском парке", open: "Пн–Вс 09:00–17:00", kid: "Стелла, мы пойдём смотреть на больших жирафов и слонов! А потом будет дом, где живут разноцветные птички.", tip: "Берите бутылочки с водой — внутри питьевых фонтанчиков мало. Лучшее время 10:00–12:30.", lng: 19.0793, lat: 47.5181 },
      { id: "b2", name: "Венгерский музей естествознания", emoji: "🦴", tag: "science", dist: "1.6 км · трамвай 24", dur: "2 часа", age: "5+", price: "€18 семья", subtitle: "Скелеты динозавров, интерактивная зона. Идеально для Каролины и Натана.", addr: "Ludovika tér 2–6", open: "Ср–Вс 10:00–18:00", kid: "Натан, представь — там настоящие скелеты динозавров, выше Димы! И можно потрогать кости мамонта.", tip: "По средам бесплатно для детей до 6. Кафе внутри — без бронирования, дёшево.", lng: 19.0848, lat: 47.4836 },
      { id: "b3", name: "MiniPolisz", emoji: "🏙", tag: "kids", dist: "450 м · 6 мин пешком", dur: "2.5 часа", age: "2–10", price: "€32 за 3х детей", subtitle: "Игровой город — дети «работают» в банке, пожарной, пекарне.", addr: "Bajcsy-Zsilinszky út 17", open: "Пн–Вс 10:00–19:00", kid: "Каролина, ты будешь работать в настоящей пекарне и печь хлеб! А ещё там есть пожарная машина.", tip: "Бронь онлайн — слоты по 2 часа. Идеально на дождливый день.", lng: 19.054, lat: 47.501 },
      ...
      { id: "b6", name: "Купальни Сечени", emoji: "♨️", tag: "wow", dist: "450 м · 6 мин пешком", dur: "2 часа", age: "3+", price: "€60 семья", subtitle: "Термальные ванны под открытым небом, в Городском парке.", addr: "Állatkerti krt. 9–11", open: "Пн–Вс 09:00–19:00", kid: "Это большой тёплый бассейн на улице, где плавают взрослые и дети!", tip: "Стелла (2г) — только в крытых детских ваннах. Берите свои тапочки — на месте дорого.", lng: 19.0815, lat: 47.5189 },
    ...
    days: [
      { date: "6 мая, ср", label: "Прилёт", items: [
        ...
        { time: "13:00", kind: "nap", text: "Сон Стеллы — все дома" },
      ...
      { date: "7 мая, чт", label: "Джетлаг + центр + магический ужин", items: [
        ...
        { time: "13:00", kind: "nap", text: "Сон Стеллы (обязательно)" },
      ...
      { date: "9 мая, сб", label: "Динозавры + парк", items: [
        ...
        { time: "13:00", kind: "nap", text: "Сон Стеллы" },
  ...
  paris: {
    ...
    places: [
      { id: "p1", name: "Disneyland Park", emoji: "🏰", tag: "wow", dist: "шаттл 8 мин", dur: "6 часов", age: "2+", price: "€420 семья", subtitle: "Главный парк. Карусели, Замок Спящей красавицы, парад в 17:00.", addr: "Bd de Parc, 77777 Coupvray", open: "Пн–Вс 09:30–22:00", kid: "Каролина, мы идём в настоящий замок принцессы! А ещё будет парад с принцессами и Микки Маусом.", tip: "Раннее открытие 08:30 для гостей отеля — пользуйтесь. Назад в Adagio к 12:30 на сон.", lng: 2.7758, lat: 48.8722 },
      { id: "p2", name: "Walt Disney Studios", emoji: "🎬", tag: "wow", dist: "шаттл 10 мин", dur: "4 часа", age: "4+", price: "входит в билет", subtitle: "Тачки, Тауэр-террор, Рататуй ride. Лучше для Натана и Каролины.", addr: "Bd de Parc, рядом с Disneyland", open: "Пн–Вс 10:00–20:00", kid: "Натан, помнишь машинки Тачки? Мы будем кататься на них как настоящие гонщики!", tip: "Стелла (2г) пропустит большинство аттракционов. Один взрослый с ней в Toy Story Land.", lng: 2.7793, lat: 48.8676 },
      { id: "p3", name: "Aquarium Sea Life", emoji: "🐠", tag: "kids", dist: "5 мин пешком", dur: "1.5 часа", age: "2+", price: "€68 семья", subtitle: "Внутри ТЦ Val d'Europe. Туннель с акулами.", addr: "Centre Commercial Val d'Europe", open: "Пн–Вс 10:00–18:00", kid: "Стелла, ты увидишь больших рыб и акул прямо над головой — мы пройдём через тоннель в океане!", tip: "Идеально на дождь или после сна — крытый, рядом с жильём. Бронируйте онлайн (-15%).", lng: 2.7811, lat: 48.8466 },
      ...
      { id: "p5", name: "Эйфелева башня (быстрая поездка)", emoji: "🗼", tag: "wow", dist: "RER A · 45 мин", dur: "4 часа", age: "5+", price: "€80 семья", subtitle: "Только для Натана и Каролины. Один взрослый со Стеллой остаётся в Adagio.", addr: "Champ de Mars, Paris", open: "Пн–Вс 09:00–23:45", kid: "Натан, это самая высокая башня в мире, мы поднимемся на лифте на самый верх!", tip: "РАЗДЕЛЕНИЕ СЕМЬИ. Один день, без Стеллы. Подъём только на 2-й этаж — очередь меньше.", lng: 2.2945, lat: 48.8584 },
      { id: "p6", name: "Chez Rémy (Disney Studios)", emoji: "🍝", tag: "food", dist: "10 мин шаттл", dur: "1 час", age: "0+", price: "€95 на 5", subtitle: "Внутри парка, тематика «Рататуй». Бронь обязательна.", addr: "Walt Disney Studios Park", open: "12:00–22:00", kid: "Каролина, помнишь крысёныша Реми? Мы будем есть в его ресторане, как маленькие мышки!", tip: "Бронь за 2 месяца! Если не забронировано — Earl of Sandwich в Disney Village без очереди.", lng: 2.7803, lat: 48.8682 },
    ],
    days: [
      ...
      { date: "14 мая, чт", label: "Париж (раздельно)", items: [
        { time: "08:30", kind: "transit", text: "Дима + Натан + Каролина: RER A → Paris Châtelet" },
        { time: "10:00", kind: "place", text: "Эйфелева башня, 2-й этаж", placeId: "p5" },
        { time: "13:00", kind: "nap", text: "Стелла спит дома с Ликой" },
  ...
  billund: {
    ...
    places: [
      { id: "l1", name: "Legoland Billund", emoji: "🧱", tag: "wow", dist: "5 мин на велосипеде", dur: "6 часов", age: "3+", price: "€280 семья", subtitle: "Оригинальный Леголенд 1968 года. Miniland, аттракционы для малышей.", addr: "Nordmarksvej 9, Биллунн", open: "Апр–окт 10:00–20:00", kid: "Натан, тут самые большие в мире модели из лего! Целые города. И настоящие аттракционы.", tip: "Купите билет на 2 дня (+€20) — за один не успеть. Стелла катается с 3 лет почти везде.", lng: 9.1278, lat: 55.7355 },
      { id: "l2", name: "Lego House", emoji: "🏠", tag: "science", dist: "10 мин на машине", dur: "4 часа", age: "4+", price: "€95 семья", subtitle: "4 этажа, 25 млн лего-кирпичей. Зоны Creative, Cognitive, Emotional.", addr: "Ole Kirks Plads 1, Биллунн", open: "Пн–Вс 10:00–18:00", kid: "Каролина, тут можно построить ВСЁ из лего! И есть ресторан, где еду тебе принесут роботы.", tip: "На дождь — идеально. Полностью крытый. Mini Chef ресторан — заказ через лего.", lng: 9.1158, lat: 55.7363 },
      { id: "l3", name: "Aquadome (Lalandia)", emoji: "🌊", tag: "kids", dist: "на территории", dur: "3 часа", age: "0+", price: "входит в коттедж", subtitle: "Крупнейший крытый аквапарк в Дании. Внутри курорта.", addr: "Lalandia Resort", open: "10:00–21:00", kid: "Стелла, это огромный бассейн с горками и волнами, прямо в нашем доме!", tip: "Не нужно никуда ехать — критично с режимом сна. Лучшее время 10:30 и 16:00.", lng: 9.1175, lat: 55.7349 },
      { id: "l4", name: "Givskud Zoo (сафари)", emoji: "🦒", tag: "wow", dist: "20 мин на машине", dur: "4 часа", age: "0+", price: "€120 семья", subtitle: "Драйв-сафари — звери приходят к машине. Слоны, львы.", addr: "Løveparkvej 3, Givskud", open: "Май–сен 10:00–17:00", kid: "Стелла, мы поедем туда, где живут настоящие львы и слоны, и они подойдут к машине!", tip: "Аренда машины обязательна. Не выходите из машины в зоне хищников.", lng: 9.2306, lat: 55.8311 },
      { id: "l5", name: "WOW Park", emoji: "🌲", tag: "kids", dist: "30 мин на машине", dur: "3 часа", age: "3+", price: "€85 семья", subtitle: "Лесной парк с верёвочными мостами и горками.", addr: "Frydendalvej 23, Lille Engesvang", open: "Апр–окт 10:00–17:00", kid: "Тут можно лазать по деревьям и кататься с огромных горок прямо в лесу!", tip: "Стелла ограничена — много активностей с 4 лет. Запасная одежда обязательна.", lng: 9.3499, lat: 56.0327 },
    ],
    days: [
      ...
      { date: "19 мая, вт", label: "В Амстердам", items: [
        ...
        { time: "13:00", kind: "nap", text: "Сон Стеллы (в самолёте/такси)" },
  ...
  amsterdam: {
    ...
    places: [
      { id: "a1", name: "NEMO Science Museum", emoji: "🔬", tag: "science", dist: "M52 · 18 мин", dur: "3 часа", age: "4+", price: "€68 семья", subtitle: "Зелёное здание-корабль. 5 этажей интерактивной науки.", addr: "Oosterdok 2", open: "Вт–Вс 10:00–17:30", kid: "Натан, тут можно делать настоящие научные эксперименты! Молнии, мыльные пузыри, химия!", tip: "Крыша бесплатна — лучший вид на город. Кафе наверху без очередей до 12.", lng: 4.9123, lat: 52.3741 },
      { id: "a2", name: "Vondelpark + Kinderkookkafé", emoji: "🌳", tag: "kids", dist: "15 мин на трамвае", dur: "2 часа", age: "0+", price: "бесплатно", subtitle: "Главный парк. Игровая площадка. Кафе, где дети сами готовят.", addr: "Vondelpark 6c", open: "Парк всегда", kid: "Каролина, в этом парке можно поиграть на огромной площадке, а потом самой приготовить пиццу в кафе!", tip: "Kinderkookkafé — бронь онлайн. 2 часа: дети готовят, родители в саду.", lng: 4.8678, lat: 52.3579 },
      { id: "a3", name: "Каналы — детский кораблик", emoji: "🚤", tag: "wow", dist: "20 мин на метро", dur: "1.5 часа", age: "2+", price: "€72 семья", subtitle: "Электрический бот по каналам. Без громких комментаторов.", addr: "Anne Frank pier", open: "Каждый час 10:00–18:00", kid: "Стелла, мы поплывём по реке прямо в городе, и будем смотреть на разноцветные дома!", tip: "Закрытый бот в дождь, открытый в солнце. Спасжилеты для детей бесплатно.", lng: 4.8838, lat: 52.3752 },
      ...
      { id: "a5", name: "Pannenkoekenhuis Upstairs", emoji: "🥞", tag: "food", dist: "10 мин пешком", dur: "1 час", age: "0+", price: "€42 на 5", subtitle: "Самые маленькие блины Амстердама на самой узкой лестнице.", addr: "Grimburgwal 2", open: "Чт–Вс 12:00–18:00", kid: "Это секретное кафе на крутой лестнице, где делают самые маленькие блинчики в мире!", tip: "Лестница КРУТАЯ — Стеллу на руках. Бронь обязательна — 4 столика всего.", lng: 4.892, lat: 52.3697 },
    ],
    days: [
      ...
      { date: "22 мая, пт", label: "Возврат домой", items: [
        ...
        { time: "13:00", kind: "nap", text: "Последний дневной сон Стеллы" },
