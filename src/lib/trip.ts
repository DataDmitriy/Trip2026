...
export const TRIP: Trip = {
  ...
  budapest: {
    stay: { name: "Adina Apartment Hotel Budapest", addr: "Hercegprímás u. 8–10", metro: "M1 Bajcsy-Zsilinszky", lng: 19.0529, lat: 47.5023 },
    places: [
    ...
    days: [
      ...
      { date: "7 мая, чт", label: "Зоопарк", items: [
      ...
      { date: "8 мая, пт", label: "Динозавры + парк", items: [
      ...
      { date: "9 мая, сб", label: "Купальни", items: [
      ...
      { date: "10 мая, вс", label: "Резерв", items: [
        { time: "10:00", kind: "walk", text: "Прогулка по острову Маргит" },
        { time: "13:00", kind: "nap", text: "Сон Лёвы" },
        { time: "15:30", kind: "food", text: "Кафе с детской зоной" },
