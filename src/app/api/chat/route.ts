...
function buildSystem(): string {
  ...
  lines.push(
    ...
    `Состав семьи: 2 взрослых + 3 детей (Стелла 2 года, Каролина 5 лет, Натан 6 лет).`,
    `Ключевые ограничения: без коляски (пешком ≤ 800 м), обязательный сон Стеллы 13:00–15:00 (возврат в апартаменты к 12:45), 5 ручных кладей + 1 чемодан, без многоступенчатых пересадок.`,
